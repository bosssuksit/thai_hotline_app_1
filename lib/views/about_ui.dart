...
class _AboutUIState extends State<AboutUI> {
  ...
  final Color myBackgroundColorCenter =
      const Color(0xFF211A16); // สีพื้นหลังเข้มตรงกลาง
  final Color myBackgroundColorEdge =
      const Color(0xFF4A3A32); // สีพื้นหลังโทนเดิมที่ขอบ
  final Color myTextColorMain =
      const Color(0xFFA09187); // สีข้อความหลัก (เช่น หัวข้อ)
  final Color myTextColorSub =
      const Color(0xFFD8D1CC); // สีข้อความรอง (เช่น ข้อมูล)
  final Color myAccentColor =
      const Color(0xFF2F6F5E); // สีเน้น (เช่น ขอบรูปโปรไฟล์, ข้อมูลบางส่วน)
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white
                              .withOpacity(0.05), // สีขาวโปร่งแสงจางๆ
                      ...
                      Text(
                        ...
                        style: GoogleFonts.kanit(
                          fontSize: 16,
                          color: myTextColorSub
                              .withOpacity(0.7), // ใช้สีเทาอ่อนจางๆ
                        ),
                      ),
                      const SizedBox(height: 48),
                      ...
                      _buildSimpleInfo('รหัสนักศึกษา', '6619410007',
                          myAccentColor), // ใช้สีเน้น
                      _buildSimpleInfo('ชื่อ-สกุลนักศึกษา',
                          'นาย ศักดิิ์สิทธิ์ ทองเผือก', Colors.white),
                      _buildSimpleInfo('อีเมล์นักศึกษา',
                          's6619410007@sau.ac.th', myTextColorSub),
